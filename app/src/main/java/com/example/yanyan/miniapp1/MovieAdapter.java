...
//        String mainchar = myList.get(0)+ myList.get(1)+ myList.get(2);


        String myList = movie.mc.get(0)+ ", " + movie.mc.get(1) + ", "+ movie.mc.get(2);

        charTextView.setText(myList);
...
//    private static ArrayList<String> getChar(String string){
